...
buildLinux (args // {
  ...
  src = applyPatches {
    src = fetchgit {
      ...
      hash = "sha256-QwsjZJccllSBmJawaqGi+7UaZ5HbgANubHfhLmP1jpo=";
      rev = "a4a971135a2ff64382ae4235b3ae60503bb1036a";
    };

    patches = [

      (fetchpatch {
        name = "optee: add timeout value to optee_notif_wait() to support timeout";
        url = "https://github.com/torvalds/linux/commit/14ca6401d8703725c7297dcc4bf8de73323411ac.patch";
        hash = "sha256-v2uT+8k1l3qgA/+ZwoHC1mRXVkgjU1uPATv4LjKhx0k=";
      })
